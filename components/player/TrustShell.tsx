...
export function TrustShell({
  ...
  return (
    <section className="mx-auto w-full max-w-[1180px] px-4 py-8 sm:px-6 lg:px-8 lg:py-12">
      <div className="overflow-hidden rounded-[2rem] border border-violet-200/15 bg-[#090b27]/86 shadow-[0_28px_90px_rgba(0,0,0,0.28)] backdrop-blur-2xl">
        <div className="border-b border-white/10 bg-[radial-gradient(circle_at_top_left,rgba(103,232,249,0.11),transparent_30%),linear-gradient(135deg,rgba(124,58,237,0.12),rgba(7,9,31,0.35))] px-5 py-6 sm:px-8 sm:py-8">
          ...
          <h1 className="mt-5 text-3xl font-black tracking-[-0.045em] text-white sm:text-5xl">
            {title}
          </h1>

          {intro ? (
            <p className="mt-4 max-w-3xl text-sm font-semibold leading-7 text-white/50 sm:text-base">
              {intro}
            </p>
          ) : null}
        </div>

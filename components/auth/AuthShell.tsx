...
export default function AuthShell({title,description,children,footer}:{eyebrow?:string;title:string;description:string;children:ReactNode;footer?:ReactNode;storyTitle?:string;storyDescription?:string}){
 return <main className={styles.page}>
  <aside className={styles.sky}><CelestialWindow/><Link href="/sign-in" className={styles.brand}><AstralIcon/><span>ANCIENT PULLS</span></Link><ConstellationArtwork className={styles.art}/><div className={styles.companion}><AsterPortrait alt="Astra"/></div></aside>

...
| --- | --- | --- | ---: | ---: |
| `litter_bowl` | `nebu-litter-bowl-v1.png` | Celestial Litter Bowl | 6 | 3.4 s |
| `balloon_incident` | `nebu-balloon-incident-v1.png` | The Balloon Incident | 7 | 3.2 s |
| `golden_yarn` | `nebu-golden-yarn-v1.png` | Golden Yarn Chase | 7 | 3.5 s |
| `bath_bird` | `nebu-bath-bird-v1.png` | Bath Time Interrupted | 6 | 3.8 s |
| `sunbeam_vault` | `nebu-sunbeam-vault-v1.png` | Sunbeam Vault | 6 | 4.2 s |
| `living_mural` | `nebu-living-mural-v1.png` | The Living Mural | 6 | 4.5 s |
| `catnip_star` | `nebu-catnip-star-v1.png` | The Catnip Star | 5 | 5.0 s |
| `solar_heist` | `nebu-solar-heist-v1.png` | Solar Barque Heist | 5 | 5.4 s |
| `constellation_chooses` | `nebu-constellation-chooses-v1.png` | The Constellation Chooses You | 5 | 5.8 s |

## Unlockable alternative performances

| Performance ID | File | Scene | Base FPS | Target duration |
| --- | --- | --- | ---: | ---: |
| `sand_sneeze` | `nebu-sand-sneeze-v1.png` | The Sand Sneeze | 7 | 3.3 s |
| `box_destiny` | `nebu-box-destiny-v1.png` | Box of Destiny | 7 | 3.6 s |
| `papyrus_mouse` | `nebu-papyrus-mouse-v1.png` | The Papyrus Mouse | 8 | 3.4 s |
| `moon_moth` | `nebu-moon-moth-v1.png` | The Moon Moth | 6 | 4.1 s |
| `temple_domino` | `nebu-temple-domino-v1.png` | Temple Domino | 7 | 3.8 s |
| `balance_heart` | `nebu-balance-heart-v1.png` | Balance of the Heart | 5 | 4.8 s |
| `papyrus_theatre` | `nebu-papyrus-theatre-v1.png` | Papyrus Theatre | 6 | 4.4 s |
| `sky_mirror` | `nebu-sky-mirror-v1.png` | The Sky Mirror | 6 | 4.6 s |
| `eclipse_thief` | `nebu-eclipse-thief-v1.png` | Eclipse Thief | 6 | 4.7 s |
| `hall_eight` | `nebu-hall-eight-v1.png` | Hall of Eight | 5 | 5.5 s |

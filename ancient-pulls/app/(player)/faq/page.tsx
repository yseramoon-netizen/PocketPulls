...
const FAQS = [
  ...
  ["Why does the wish scene get hotter?", "The gathering starlight and Aster’s reaction build with each rarity tier. The animation celebrates the result; it does not alter the server result."],
